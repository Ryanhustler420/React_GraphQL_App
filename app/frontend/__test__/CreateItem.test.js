...
//  if this comes like and external package than we can simply mock it like we did in the 'Router.router'
//  since this is not an external package we will mock global 'fetch' API which comes with browser

const dogImage = 'https://gog.com/dog.jpg';
...
describe ('<CreateItem />', () => {
  ...
  it ('uploads a file when change', async () => {
    ...
    // expect(global.fetch).toHaveBeenCalledWith('abc'); <- error
